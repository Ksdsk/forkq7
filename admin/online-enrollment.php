...
?>
      ...
      <div class="col-sm-9 mt-5">
        <p class="bg-dark text-white p-2">List of Current Enrollments in online Course <?= mysqli_fetch_assoc($resultForCourse)['course_name'];?></p>
        <table class="table table-striped">
          ...
          <tbody>
            ...
            while ($row = mysqli_fetch_array($result)) {
              ...
              <td><a href="'.$_SERVER['PHP_SELF'].'?id='.$row['online_enrollment_id'].'">Delete</a></td>
              </tr>';
              $index++;
            }
            ?>
